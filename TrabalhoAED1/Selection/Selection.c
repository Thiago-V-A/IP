...
void ord_selection(int vet[], int x) {
    int i, j, min, temp;
    for (i = 0; i < x-1; i++) {
        min = i;
        for (j = i+1; j < x; j++) {
