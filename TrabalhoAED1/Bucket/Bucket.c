...
//PARCIALMENTE COPIADO: https://www.sanfoundry.com/c-program-sorts-array-using-bucket-sort/
...
//PARCIALMENTE COPIADO: https://www.sanfoundry.com/c-program-sorts-array-using-bucket-sort/
void ord_bucket(int array[], int size){
